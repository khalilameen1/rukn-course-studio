...
def _ensure_course_columns() -> None:
    ...
    additions: dict[str, str] = {
        ...
        "web_source_memory_json": "TEXT",
        "course_domain": "TEXT",
        "course_specialty": "TEXT",
        "primary_course_family": "TEXT DEFAULT 'general_skill'",
        "secondary_course_families_json": "TEXT DEFAULT '[]'",
        "student_language": "TEXT DEFAULT 'ar'",
        "spoken_variety": "TEXT DEFAULT 'egyptian_colloquial'",
        "address_form": "TEXT DEFAULT 'masculine'",
        "learner_starting_state": "TEXT DEFAULT ''",
        "required_final_performance": "TEXT DEFAULT ''",
        "required_independence_level": "TEXT DEFAULT 'independent_with_checklist'",
        "instructor_responsibility_boundaries_json": "TEXT DEFAULT '[]'",
        "verified_instructor_experience_json": "TEXT DEFAULT '[]'",
        "forbidden_first_person_claims_json": "TEXT DEFAULT '[]'",
        "realistic_student_budget": "TEXT",
        "available_tools_json": "TEXT DEFAULT '[]'",
        "professional_constraints_json": "TEXT DEFAULT '[]'",
        "high_stakes_constraints_json": "TEXT DEFAULT '[]'",
...
def _widen_str_enum_columns() -> None:
    ...
    targets = (
        ...
        ("courses", "primary_course_family", 64),
        ("courses", "address_form", 32),
...
def _normalize_str_enum_storage() -> None:
    ...
    targets: list[tuple[str, str, type[Enum]]] = [
        ...
        ("courses", "primary_course_family", CourseFamily),
        ("courses", "address_form", AddressForm),
